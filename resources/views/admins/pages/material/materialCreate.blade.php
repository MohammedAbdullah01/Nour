    ...
    <main id="main" class="main">
        ...
        <div class="container">
            <div class="row">
                ...
                <form class="mt-4" action="{{ route('admin.material.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 ">
                            ...
                            <input type="text" class="form-control" name="specs" value="{{ old('specs') }}"
                        ...
                        <div class="col-md-6 mb-3 ">
                            ...
                            <input type="number" class="form-control" name="numser" value="{{ old('numser') }}"
